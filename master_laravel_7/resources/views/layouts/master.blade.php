...
<head>
  ...
  <title>Covid19:_Depok</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="implugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('frontend')}}/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-danger navbar-badge">120</span>
        </a>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-warning navbar-badge">220K</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('frontend')}}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">COVID-19:Depok</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Alia Cilvia Maulida<p>Administrator</p></a>
        </div>
      </div>
     ...
     <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <a class="nav-link" href="{{ ('medicare2') }}/index.html">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="{{ ('inputdata') }}/index.html">
...
<section class="header5 cid-r7o72Bhmed mbr-fullscreen" id="header5-3">
    ...
    <div class="form-row">
            ...
            <br> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1982.472112179113!2d106.77038862969272!3d-6.401188430561456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69e8df8b207307%3A0xe3dcd7b5fb52954!2sRS%20Permata%20Depok!5e0!3m2!1sid!2sid!4v1601279916261!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
           
            <div class="container-contact100-form-btn">
            <button class="contact100-form-btn"> <a href="#" class="nav-link active">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; Covid19:Depok2020-2021All rights reserved.
       <a href="https://www.rspermata.co.id/hospital/rs-permata-depok"></a>.</strong>
